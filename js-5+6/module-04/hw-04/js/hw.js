...
/*
  Создайте скрипт кассира, который:
  1) получает список продуктов и деньги, 
  2) подсчитывает общую стоимость продуктов, 
  3) и в зависимости от того хватает 
...
function Cashier(name, productsDatabase) {
  ...
  this.countTotalPrice = function (order) {
    ...
    for (const key in order) {
      this.totalPrice = total += order[key] * this.productsDatabase[key];
    }
  };
  ...
  this.countChange = function () {
    const result = this.customerMoney - this.totalPrice;
    this.changeAmount = result >= 0
